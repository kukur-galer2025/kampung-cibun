...
export default function ProductsAdmin() {
  ...
  const fetchData = async () => { try { setItems(await (await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://apikampungcibun.amania.id'}/api/products`)).json()); } catch {} finally { setLoading(false); } };
  useEffect(() => { fetchData(); }, []);
